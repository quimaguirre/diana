...
def parse_results():
    ...
    plot_name = results_dir + '/classification_analysis_noclass_onetype.png'
    ...
    for classification in classifications:
        ...
        setBoxColors(bp, len(['in classification', 'not in classification']))
    ...
    legend([hG, hR],['in classification', 'not in classification'])
    hG.set_visible(False)
    hR.set_visible(False)

    savefig(plot_name, format='png')
    show()
