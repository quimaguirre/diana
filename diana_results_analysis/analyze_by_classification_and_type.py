...
def parse_results():
    ...
    plot_name = results_dir + '/figures/classification_and_type.eps'

    # File with results of Mann Whitney tests:
    mannwhitney_file = results_dir + '/tables/classification_and_type_mannwhitney.txt'
    mannwhitney_struc_file = results_dir + '/tables/classification_and_type_mannwhitneystruc.txt'

    # Results table:
    results_table = results_dir + '/tables/classification_and_type_table.txt'
...
def setBoxColors(bp, length):
    ...
    bp['boxes'][4].set_facecolor('#aeaeae') #light grey
