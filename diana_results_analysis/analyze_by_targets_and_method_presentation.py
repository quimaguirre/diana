...
def parse_results():
    ...
    plot_name = results_dir + '/figures/targets_and_method_{}{}_presentation.eps'.format(greater_or_smaller,me_too_str)
    plot_name_png = results_dir + '/figures/targets_and_method_{}{}_presentation.png'.format(greater_or_smaller,me_too_str)
