...
def parse_results():
    ...
    plot_name = results_dir + '/targets_analysis_diffrelpathways_lessmethods_{}.eps'.format(greater_or_smaller)
    ...
    legend([hG, hY, hR],types_analysis)
...
def setBoxColors(bp, length):
    ...
    """
    if length != 3:
        print('\nERROR: This function is thought to work on groups of 3 types of analysis. Redo the function!!\n')
        sys.exit(10)
    ...
    setp(bp['boxes'][1], color='#d48900')
    setp(bp['caps'][2], color='#d48900')
    setp(bp['caps'][3], color='#d48900')
    setp(bp['whiskers'][2], color='#d48900')
    setp(bp['whiskers'][3], color='#d48900')
    setp(bp['medians'][1], color='black')
    bp['boxes'][1].set_facecolor('#fbc562') #orange

    setp(bp['boxes'][2], color='#b80000')
    setp(bp['caps'][4], color='#b80000')
    setp(bp['caps'][5], color='#b80000')
    setp(bp['whiskers'][4], color='#b80000')
    setp(bp['whiskers'][5], color='#b80000')
    setp(bp['medians'][2], color='black')
    bp['boxes'][2].set_facecolor('#ff7373') #red
