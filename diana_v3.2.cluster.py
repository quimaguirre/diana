        ...
        if options.extended != None:
            ...
            if comparison_mode == True:
                ...
                for top in top_thresholds_list:
                    node_profile_file = results_dir + "/node_profile_"+str(top)+".txt"
            ...
            if comparison_mode == True:
                list_files = []
                for top in top_thresholds_list:
                    functional_profile_file = results_dir + "/functional_profile_top_"+str(top)+".txt"
            ...
            if comparison_mode == True:
                list_files = []
                for top in top_thresholds_list:
                    edge_profile_file = results_dir + "/edge_profile_top_"+str(top)+".txt"
