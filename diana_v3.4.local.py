...
def run_diana(options):
    ...
    for top in extended_dataframe['functional']:
        fot.write('{}\t{}\t'.format(top[1], top[3]))
        fot.write('{}\t{}\t{}\t{}\t'.format(top[7], top[8], top[9], top[10])) # Top 50 and Top 100 Sp and Dp
    ...
    fot.write('{}\t{}\t{}\t{}\t'.format(summary['top50_linker_functional'][1], summary['top50_linker_functional'][0], summary['top100_linker_functional'][1], summary['top100_linker_functional'][0])) # Top 50 and Top 100 Sp and Dp
